/**
 * Reference test: Boost ABCD against Boost_closed_V3.m structure.
 * Values computed for the default operating point (Vref=21, d_ss=0.4286).
...
const checks = [
  ['A[1][0]', A[1][0], 34758.4289],
  ['A[0][1]', A[0][1], -5714.2857],
  ['A[0][4]', A[0][4], 1381.0948],
  ['B[0]',    B[0][0], 5714.2857],
  ['A[7][7]', A[7][7], 0],
];
let fail = 0;
